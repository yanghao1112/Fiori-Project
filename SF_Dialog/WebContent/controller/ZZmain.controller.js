...
//			var source = aControlEvent.getSource();
		...
		handleClick: function(aControlEvent) {
			...
			if(this._oPopup.length <= 2) {
				...
				this._oPopup.push(oPopup);
				var _oDialogPop = sap.ui.xmlfragment(
						"sap.ui.demo.wt.view.ProjectInfo", this);
			} else {
				return;
			}
			...
			_oDialogPop.setModel(oModel);
			_oDialogPop.setModel(this.getView().getModel("list"),"list");
			_oDialogPop.setModel(this.getView().getModel("radarData2"),"radarData2");
			_oDialogPop.setModel(this.getView().getModel("radarOption2"),"radarOption2");
			_oDialogPop.setModel(this.getView().getModel("radarData3"),"radarData3");
			_oDialogPop.setModel(this.getView().getModel("radarOption3"),"radarOption3");
			_oDialogPop.setModel(this.getView().getModel("radarOption3"),"radarOption3");
			oPopup.setContent(_oDialogPop);
			...
			var oVizFrame = _oDialogPop.getContent()[0].getContent()[1].getContent()[1].
			getAggregation("items")[2].getContent()[0];
			...
			var oPieChartModel = this.getView().getModel("pieChartData");
