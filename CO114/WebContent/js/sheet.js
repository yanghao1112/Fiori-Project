...
sap.ui.define(["sap/ZG001/Sample/CO114/js/jszip"],
function(JSZip) {
...
//	0x1D: { n:'PtgSxName', f:parse_PtgSxName }, // TODO
    ...
    function col_obj_w(C, col) {
        ...
        /* Yang */
        if (col.outlineLevel) p.outlineLevel = col.outlineLevel;
        return p;
    }
    ...
    function write_ws_xml(idx, opts, wb, rels) {
        ...
        //zzzzzzzzzzz
        //o[o.length] = (writextag('sheetPr', null, {'tabColor': escapexml(wb.SheetNames[idx])}));
            ...
            _addFill: function (attributes) {
                ...
                if (attributes.fgColor) {
                    ...
                    if (!attributes.bgColor) {
                        attributes.bgColor = {"indexed": "9"}
                    }
                }

                if (attributes.bgColor) {
                    var $bgColor = XmlNode('bgColor').attr('rgb', attributes.bgColor.rgb);
