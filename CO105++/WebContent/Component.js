sap.ui.define([
	...
	return UIComponent.extend("sap.ZZZ01.ZCHARTTEST.Component", {
		...
		init: function() {
			...
			oCore.loadLibrary('sap/ZZZ01/ZCHARTTEST/js', {url:'js', async:true});
			...
			var oModel1 = new sap.ui.model.json.JSONModel(jQuery.sap.getModulePath(
							"sap.ZZZ01.ZCHARTTEST.data","/data.json"));
			
			var oModels = new sap.ui.model.json.JSONModel(jQuery.sap.getModulePath(
					"sap.ZZZ01.ZCHARTTEST.data","/select.json"));
			
			this.setModel(oModel1 );
			this.setModel(oModel1, "list" );
			this.setModel(oModels, "Select" );
