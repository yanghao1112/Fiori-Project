jQuery.sap.declare("sap.ZG001.timesheet.input.dailyDemo.util.Formatter");
sap.ZG001.timesheet.input.dailyDemo.util.Formatter = {
/*	fmtCodeText : function(aCode, aText) {
	...
	fmtVis : function(aVisible,aNoPhone) {
		return aVisible && aNoPhone;
	}
}
