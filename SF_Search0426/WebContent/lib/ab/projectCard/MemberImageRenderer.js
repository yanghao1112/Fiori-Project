...
//			rm.writeControlData(oImage);
		...
		// Add leader border to LEP or LEM
		// ABeam
		if( oControl.getProperty("LEP") === true ||
				oControl.getProperty("LEM") === true ) {
		...
		if (oControl.getProperty("LEP") === true &&
				oControl.getProperty("LEM") === false ) {
			rm.write("<img");
			...
			rm.writeStyles();
			rm.write("/>");
		} else if (oControl.getProperty("LEM") === true &&
				oControl.getProperty("LEP") === false ) {
			rm.write("<img");
			rm.addClass("ZMemberImageTypeFirst");
			rm.writeClasses();
			...
			rm.writeStyles();
			rm.write("/>");
		} else if ( oControl.getProperty("LEP") === true &&
				oControl.getProperty("LEM") === true ) {
			rm.write("<img");
			rm.addClass("ZMemberImageTypeFirst");
			rm.writeClasses();
