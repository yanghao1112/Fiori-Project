...
//	var bIsInitialized = false;
	...
	let oZHE_INDUSTRY = BaseObject.extend("sap.pwaa.valuehelp.util.ZHE_INDUSTRY", {
...
//		bIsInitialized = true;
		...
		oTemplate = new sap.m.ColumnListItem({
			...
			cells : [  new sap.m.ObjectIdentifier({
				title : "{result>clientIndustryCode}"
			}), new sap.m.ObjectIdentifier({
				title : "{result>clientIndustryName}"
			}) ]
		...
		oValueHelpDialog = sap.ui.xmlfragment(
				"sap.pwaa.valuehelp.view.ZHE_INDUSTRY_VH", this);

		/* Create FilterBar */
		oFilterBar = sap.ui.getCore().byId("ZHE_INDUSTRY_FB");
...
//		 }));
		...
		oResultTable = sap.ui.xmlfragment(
				"sap.pwaa.valuehelp.view.ZHE_INDUSTRY_RT", this);
