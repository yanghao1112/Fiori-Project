 ...
 */
jQuery.sap.declare("sap.ZG001.timesheet.input.daily.util.DataManager");
...
sap.ui.base.EventProvider
	.extend(
		"sap.ZG001.timesheet.input.daily.DataManager", {
			...
			processError: function(aError) {
				...
				if (aError.response) {
					...
					try {
						...
						jQuery.sap.log.warning("Could parse the response", ["parseError"], ["sap.ZG001.timesheet.input.daily"]);
					}
				}
				if (sMessage === "") {
