...
//						return;
						...
						var x = oControl.getOption().w / iLengendOptionCounts;
						oRm.write('<svg ');
						oRm.addClass('sapUiSmallMargin');
						oRm.writeClasses();
						oRm.writeAttribute('width', oControl.getOption().w);
						...
						for(var iIndex = 0; iIndex < oData.length; iIndex++) {
							...
							var lineStyle = "stroke:" + oData[iIndex].classColor + ";stroke-width:2"
							...
							oRm.write('>');
							oRm.write('<tspan>' + oData[iIndex].classText + '</tspan>');
							oRm.write('</text>');
							oRm.write('</g>');
						}
						oRm.write('</svg>');
					...
					oRm.writeClasses();
					oRm.writeAttribute('width', oControl.getOption().w);
					oRm.writeAttribute('height', oControl.getOption().h);
					oRm.writeStyles();
				...
				function onAfterRendering(){
					if ( !this.getData() || !this.getOption()) {
						return;
					}
