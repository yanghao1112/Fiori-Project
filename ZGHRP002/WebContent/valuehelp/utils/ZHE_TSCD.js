(function(){
	...
	jQuery.sap.declare("sap.ZG001.timesheet.valuehelp.utils.ZHE_TSCD");
		...
		jQuery.each(oSearchModel.getData(), function(aKey, aVal){
			if (aVal !== ""){
				if (aKey === "FREE_TEXT"){
					...
					oConds["ZtsMaCd"].push(new sap.ui.model.Filter("ZtsMaCd", "Contains", aVal));
					oConds["ZtsTx"].push(new sap.ui.model.Filter("ZtsTx", "Contains", aVal));
				}
				else{
	...
	sap.ZG001.timesheet.valuehelp.utils.ZHE_TSCD = {
