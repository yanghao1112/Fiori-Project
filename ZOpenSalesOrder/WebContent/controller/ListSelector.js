sap.ui.define([
		...
		return BaseObject.extend("SalesOrderList.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias mdtest.model.ListSelector
			 */
			 ...
			 * @return {mdtest.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
