sap.ui.define([
		...
		return BaseObject.extend("soreturn.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias soreturn.model.ListSelector
			 */
			 ...
			 * @return {soreturn.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
