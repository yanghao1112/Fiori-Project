            ...
            e.exports = function(t) {
                ...
                t.controllers.line = t.DatasetController.extend({
                    ...
                    updateBezierControlPoints: function() {
                        ...
                        else for (r = 0, l = o.length; l > r; ++r) s = o[r],
                        d = s._model,
                        ...
                        if (e.chart.options.elements.line.capBezierPoints) for (r = 0, l = o.length; l > r; ++r) d = o[r]._model,
            ...
            e.exports = function(t) {
                ...
                t.defaults.polarArea = {
                    ...
                    legendCallback: function(t) {
                        ...
                        i = a.datasets,
                        n = a.labels;
                        if (i.length) for (var o = 0; o < i[0].data.length; ++o) e.push('<li><span style="background-color:' + i[0].backgroundColor[o] + '">'),
                        n[o] && e.push(n[o]),
                        e.push("</span></li>");
                        return e.push("</ul>"),
                        e.join("")
            ...
            e.exports = function(t) {
                ...
                e.extend(t.Controller.prototype, {
                    ...
                    getElementsAtEvent: function(t) {
                        ...
                        return o ? (e.each(a.data.datasets,
                        function(t, e) {
                    ...
                    bindEvents: function() {
                        var t = this;
                        e.bindEvents(t, t.options.events,
                        function(e) {
                            t.eventHandler(e)
                        })
                    },
            ...
            e.exports = function(t) {
                ...
                o.configMerge = function(e) {
                    ...
                    function(e) {
                        o.each(e,
                        function(e, i) {
                            if ("scales" === i) a[i] = o.scaleMerge(a.hasOwnProperty(i) ? a[i] : {},
                            e);
                            else if ("scale" === i) a[i] = o.configMerge(a.hasOwnProperty(i) ? a[i] : {},
            ...
            e.exports = function(t) {
                ...
                t.Legend = t.Element.extend({
                    ...
                    handleEvent: function(t) {
                        ...
                        o = i.y,
                        r = a.options;
                        if (n >= a.left && n <= a.right && o >= a.top && o <= a.bottom) for (var l = a.legendHitBoxes,
                        s = 0; s < l.length; ++s) {
                            var d = l[s];
                ...
                t.Scale = t.Element.extend({
                    ...
                    draw: function(a) {
                        ...
                        if (n.display) {
                            ...
                            var F = [];
                            if (g) {
                                if (o = !1, h && (T /= 2), (T + d.autoSkipPadding) * i.ticks.length > i.width - (i.paddingLeft + i.paddingRight) && (o = 1 + Math.floor((T + d.autoSkipPadding) * i.ticks.length / (i.width - (i.paddingLeft + i.paddingRight)))), r && i.ticks.length > r) for (; ! o || i.ticks.length / (o || 1) > r;) o || (o = 1),
                                o += 1;
                                f || (o = !1)
                            }
                            ...
                            function(t) {
                                if (u.display && (l.save(), l.lineWidth = t.glWidth, l.strokeStyle = t.glColor, l.setLineDash && (l.setLineDash(t.glBorderDash), l.lineDashOffset = t.glBorderDashOffset), l.beginPath(), u.drawTicks && (l.moveTo(t.tx1, t.ty1), l.lineTo(t.tx2, t.ty2)), u.drawOnChartArea && (l.moveTo(t.x1, t.y1), l.lineTo(t.x2, t.y2)), l.stroke(), l.restore()), d.display) {
                                    ...
                                    n = 0; i < a.length; ++i) l.fillText("" + a[i], 0, n),
                                    n += 1.5 * m;
                ...
                t.Tooltip = t.Element.extend({
                    ...
                    drawTitle: function(t, e, a, i) {
                        ...
                        if (o.length) {
                            ...
                            var d, u;
                            for (d = 0, u = o.length; u > d; ++d) a.fillText(o[d], t.x, t.y),
                            t.y += r + l,
            ...
            e.exports = function(t) {
                ...
                i = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        i = a.ticks,
                        n = e.getValueOrDefault,
                        o = t.ticks = [], r = n(i.min, Math.pow(10, Math.floor(e.log10(t.min)))); r < t.max;) {
                            o.push(r);
                            var l, s;
            ...
            e.exports = function(t) {
                ...
                o = t.Scale.extend({
                    ...
                    buildTicks: function() {
                        ...
                        var C = i.ticks[i.ticks.length - 1].diff(i.lastTick, i.tickUnit); (0 !== C || 0 === i.scaleSizeInUnits) && (i.options.time.max ? (i.ticks.push(i.lastTick.clone()), i.scaleSizeInUnits = i.lastTick.diff(i.ticks[0], i.tickUnit, !0)) : (i.ticks.push(i.lastTick.clone()), i.scaleSizeInUnits = i.lastTick.diff(i.firstTick, i.tickUnit, !0))),
                        i.ctx.restore()
                    },
                    getLabelForIndex: function(t, e) {
                        var a = this,
