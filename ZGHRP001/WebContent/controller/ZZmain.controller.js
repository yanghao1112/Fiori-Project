...
jQuery.sap.require("sap.ZG001.timesheet.input.daily.util.Formatter");
jQuery.sap.require("sap.ZG001.timesheet.input.daily.util.DataManager");
sap.ui.define([
	...
	"use strict";
	return Controller.extend("sap.ZG001.timesheet.input.daily.controller.ZZmain", {
		onInit : function(oEvent) {
			...
			if (!this.oDataManager) {
				this.oDataManager = new sap.ZG001.timesheet.input.daily.DataManager(this.oDataModel,this.oBundle);
			}
...
//		},
		...
		_createEngagementTab : function() {
			"use strict";
			var oTabContainerItem = sap.ui.xmlfragment("sap.ZG001.timesheet.input.daily.view.TabContainerItem",
					this);
		...
		onProxyPress: function() {
			...
			if (!this._oDialogSubEntry) {
				this._oDialogSubEntry = sap.ui.xmlfragment(
						"sap.ZG001.timesheet.input.daily.view.SubEntry",
						this);
